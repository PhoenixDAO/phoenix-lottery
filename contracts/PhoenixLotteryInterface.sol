...
interface PhoenixLotteryInterface {
    ...
    function createLottery(bytes32 _name, string calldata _description, uint256 _phoenixPricePerTicket, uint256 _phoenixReward, uint256 _beginningTimestamp, uint256 _endTimestamp, uint256 _fee, address payable _feeReceiver) external returns(uint256);
